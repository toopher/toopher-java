...
public class ToopherApi {
    ...
    /**
     * Extract JSON response object from API response
     */
    ...
    /**
     * Extract QR image byte[] from API response
     */
    ...
    /**
     * Throw new error message based on status code provided in API response
     *
