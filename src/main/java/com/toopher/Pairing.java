...
/**
 * Provide information about the status of a pairing request
 */
public class Pairing extends ApiResponseObject {
    /**
     * The {@link com.toopher.ToopherApi} associated with the pairing
     */
    public ToopherApi api;

    /**
     * The unique id for the pairing
     */
    public String id;
    ...
    /**
     * Indicates if the user has responded to the pairing
     */
    public boolean pending;

    /**
     * The {@link com.toopher.User} associated with the pairing
     */
    public User user;
    ...
    /**
     * Retrieve QR code image for the pairing from the API
     *
     ...
     * @throws JSONException Thrown by the JSON.org classes when an exceptional condition is encountered
     */
